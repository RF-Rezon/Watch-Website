...
const Footer = () => {
  return (
    <div>
                ...
                <li>
                  ...
                  >
                    <div className="flex gap-x-3 items-center">
                      ...
                      <span>
                        No:58 A, East Madison Street, Baltmre, MD, USA, 4508
                      </span>
                    </div>
                  </a>
                </li>
      ...
      <div className="h-[66px] w-full bg-customBlue flex items-center justify-evenly gap-x-60">
        <div>
          <p className="text-customGray font-medium text-lg">All Right Reserved © 2023, Design Themes</p>
        </div>
