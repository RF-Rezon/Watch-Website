  ...
  return (
    <div className='h-1/2'>
        <div className='flex bg-custonBlackBg p-20'>
            <div className='basis-1/2 flex flex-col items-start justify-center gap-y-4 overflow-hidden border-b-4 border-b-customGold'>
                <p className="text-white font-medium text-2xl py-2 font-playfair">Roman or Numeral</p>
