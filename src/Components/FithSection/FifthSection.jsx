...
const FifthSection = () => {
  return (
    <div>
      <div className="grid grid-cols-3 bg-purple-500">
        <div className="h-80 relative">
          ...
          <div data-aos="fade-up" data-aos-duration="700" className="absolute top-[25%] left-[5%] flex flex-col items-center justify-center gap-y-2">
            ...
            <button className="uppercase w-52 py-3 my-2 px-4 bg-buttonBg font-medium border-b-[3px] border-b-customGold text-white">
              View All Products
            </button>
          </div>
        </div>
        ...
        <div className="h-80 relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-custonBlackBg hover:opacity-0 opacity-30"></div>
          <div data-aos="fade-up" data-aos-duration="700" className="absolute top-[25%] left-[5%] flex flex-col items-center justify-center gap-y-2">
            <p className="text-white font-medium font-playfair text-2xl">2019 Novalties</p>
            <p className="py-1 text-customGray px-3 font-medium text-base">
