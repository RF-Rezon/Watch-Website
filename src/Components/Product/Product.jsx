    ...
    <div className="h-full">
      ...
      <div className="grid grid-cols-2 w-full bg-custonBlackBg">
        ...
        <div className="flex items-start pt-20 justify-center">
          <div>
            <p className="text-4xl font-medium text-white py-8 font-playfair">
              Analog Numeral
            </p>
            <div className="flex gap-x-5">
              <div className="text-customGray space-y-4">
                ...
                <p>Availablity</p>
                <p>Sub Total</p>
                <button className="uppercase w-full py-3 px-4 bg-buttonBg font-medium border-b-[3px] border-b-customGold text-white">
                  Add to Cart
                </button>
              </div>
              <div className="text-customGray space-y-4">
            ...
            <button className="uppercase w-full py-3 px-4 my-4 bg-buttonBg font-medium border-b-[3px] border-b-customGold text-white">
              Watch wishlist
            </button>
            <p className="text-customGray font-semibold text-xl underline mt-10">
